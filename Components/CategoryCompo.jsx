...
import { ELEVATION_LEVELS } from "../styles/elevationStyles";
  ...
  return (
    <View style={{ width: "47%" }}>
      ...
      >
        <View style={[styles.catIconandNum, { width: "100%" }]}>
          ...
          >
            {category === "Banking" ? (
              ...
              <UserRound size={27} color={catColors.accent} strokeWidth={2.1} />
            ) : category === "Developer" ? (
              <FontAwesome6 name="code" size={25} color={catColors.accent} />
            ) : category === "Wifi" ? (
              <Wifi size={27} color={catColors.accent} strokeWidth={3} />
            ) : category === "Social" ? (
              <Globe size={27} color={catColors.accent} strokeWidth={2.2} />
            ) : (
          ...
          <View style={[styles.catIconandNum, { gap: 5 }]}>
            <Text
              style={{ color: catColors.accent, fontSize: 16, fontWeight: 800 }}
            >
              {quantity}
            </Text>
            <MaterialIcons
        ...
        >
          <Text
            style={{ color: catColors.accent, fontSize: 17, fontWeight: 800 }}
          >
            {category}
          </Text>
        </View>
